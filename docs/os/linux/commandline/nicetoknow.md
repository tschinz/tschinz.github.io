...
| [delta](https://github.com/dandavison/delta)        | `diff`    | Visual Diff           | `delta old/file new/file`       | Enhance the git diff output with improved layout and styling                                                                   |
...
| [dotter](https://github.com/SuperCuber/dotter)      | -         | dotfile management    | `dotter deploy`                 | dotfile generation and template engine                                                                                         |
